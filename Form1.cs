...
namespace Lab7_2
{
    public partial class Form1 : Form
    {
        ...
        public void DrawPolyhedrFaces()
        {
            ...
            {
                Point3 v = Vector_Normal(edg);

                if(Angle_Scale(new Point3(1, 1, -1), v))
                {
                    newpoly.edges.Add(edg);
